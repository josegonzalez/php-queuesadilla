...
Queuesadilla loves to welcome your contributions. There are several ways to help out:
...
* Contribute to the [documentation](https://github.com/josegonzalez/php-queuesadilla/tree/gh-pages)
...
Queuesadilla tests requires [PHPUnit](http://www.phpunit.de/manual/current/en/installation.html)
...
* [Bug tracker](https://github.com/josegonzalez/php-queuesadilla/issues)
